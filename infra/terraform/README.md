...
このPoCのAzureリソースとGitHub ActionsのRepository Variablesを管理します。アプリのイメージ更新はTerraformから切り離し、[デプロイ用ワークフロー](../../.github/workflows/app-deploy.yaml)に任せます。

ACRとKey Vaultの末尾は、Bicep版と同じ名前で再作成できるよう `20260921` に固定しています。
